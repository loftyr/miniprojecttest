...
<html lang="en">
  ...
  <body>
    ...
    <div class="main">
      <h3 class="text-center">Selamat Datang Di Mini Project Tiket Dan Travel</h3>
      <p class="text-center">Service yang kami tawarkan !!!</p>

      <div class="panel" id="satu">
        <h2 class="text-center">Car</h2>

        <form action="page/hasilcari.php" method="POST">
      ...
      <div class="panel" id="dua">
        ...
        <form action="page/hasilcariguides.php" method="POST">       
          <div class="form-group">
            <label for="lokasi">Input Lokasi</label>
